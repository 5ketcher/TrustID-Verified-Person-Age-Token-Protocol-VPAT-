...
The **OpenVPT Minor Standard** defines a constrained, privacy-first profile of the
OpenVPT protocol for minor subjects.

It enables age-based access control without creating persistent child identities
or exposing personal data about minors or their legal guardians.

---

## 2. Scope

Applies to subjects under the age of majority where only age category verification
is required.

This standard explicitly **does not define a child digital identity**.
...
- Never issues OpenVPT or VPT tokens  
...
- Token `sub` MUST be pairwise per Relying Party  
...
```json
{
  ...
  "exp": 1735689900,
  "jti": "a9f3c1e2",
  "policy_profile": "openvpt-minors-1.0",
  "age_bracket": "13+",
...
The OpenVPT Minor Standard does not identify children.
It defines only what systems may responsibly know about them.

---

# End of OpenVPT Minor Standard
